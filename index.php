                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="computer.html">Informática</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="laptop.html">Laptop</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="product.html">Produto</a>
                              </li>
                              <li class="nav-item">
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="box_text">
                     ...
                     <h3>Computador</h3>
                     <p>Existem muitas variações de passagens de Lorem Ipsum disponíveis, mas a maioria sofreu alterações de alguma forma, por injeção de humor ou palavras aleatórias que não parecem nem um pouco verossímeis. </p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box_text">
                     ...
                     <div class="row">
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              ...
                              <h3 >Computer</h3>
                              <br>
                              <p style=" font-size: 20px; "><h2><span class="fa fa-money"></span> 200.000,00 kz</h2></p>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                        ...
                        <div class="col-md-4">
                           <div class="product_box">
                              ...
                              <h3>Bettery</h3>
                              <br>
                              <p style=" font-size: 20px; "><h2><span class="fa fa-shopping-cart"></span> 200.000,00 kz</h2></p>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="product_box">
                        ...
                        <div class="col-md-12">
                           <input class="read_more" placeholder="Pesquisar" class=" form-control">
                        </div>
               ...
               <div class="col-md-10 offset-md-1">
                  <form id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <textarea class="textarea" placeholder="Message" type="type" Message="Name">Messagem </textarea>
                        </div>
                        <div class="col-md-12">
         ...
         <div class="footer">
               ...
               <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <form class="bottom_form">
                        ...
                        <input class="enter" placeholder="Insira o E-mail para receber notificaçôes" type="text" name="Enter your email">
                        <button class="sub_btn">submeter</button>
                     </form>
                  </div>
               </div>
            </div>
            <div class="copyright">
               <div class="container">
                  <div class="row">
                  <div class="col-md-12">
                        <p>© 2019 Todos os direitos reservados.<a href="https://html.design/"> Ribeiro Gomes Rodrigues</a></p>
                     </div>
                  </div>
               </div>
            </div>
